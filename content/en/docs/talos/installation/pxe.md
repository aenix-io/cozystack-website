...
```bash
sudo docker run --name=matchbox -d --net=host ghcr.io/aenix-io/cozystack/matchbox:v0.25.1 \
  -address=:8080 \
  -log-level=debug
```
...
6bf638f0808e   ghcr.io/aenix-io/cozystack/matchbox:v0.25.1         "/matchbox -address=…"   3 minutes ago    Up 3 minutes              matchbox
```
